...
//    if (args.length != 3) {
//      System.out.println("p: unshare_profile <consumerKey> <consumerSecret> <adminEmail>");
//    } else {
      String consumerKey ="";// args[0];
      String consumerSecret = "132762chesneau";// args[1];
      String adminEmail = "ches.damien@gmail.com";//args[2];
